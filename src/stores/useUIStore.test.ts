...
describe('useUIStore', () => {
  ...
  it('persists durable state under the mindflow-ui key', async () => {
    const { useUIStore } = await loadStore();
    ...
    const persisted = parsePersistedState('mindflow-ui');
  ...
  it('migrates legacy neurone-ui storage into mindflow-ui', async () => {
