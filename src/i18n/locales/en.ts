...
export default {
  ...
  overview: {
    ...
    openClawDesc: 'MindFlow is using the same OpenClaw files. {count} artifact files detected.',
  ...
  ai: {
    ...
    welcomeAgent: 'I am MindFlow Agent. Tell me what you want to get done.',
  ...
  file: {
    ...
    voiceRecordHint: 'Record a voice note. MindFlow saves it and creates a summary when you finish.',
  ...
  ribbon: {
    ...
    starProject: 'Star MindFlow on GitHub',
  ...
  plugins: {
    ...
    title: 'Plugins',
    intro: 'MindFlow prefers the default plugin folder near the installation location, and also supports workspace .mindflow/plugins, user plugin directory, and bundled resources.',
  ...
  settingsModal: {
    ...
    openClawTitle: 'OpenClaw Workspace',
    openClawDesc: 'Attach an external OpenClaw workspace so MindFlow and OpenClaw work on the same files.',
    openClawEnabled: 'Enable integration',
    openClawDisabledDesc: 'OpenClaw integration is currently disabled. MindFlow will treat the workspace as a normal folder until you re-enable it.',
    ...
    openClawMountedWorkspaceHint: 'Choose the external OpenClaw workspace path to attach to this MindFlow workspace.',
    ...
    openClawBoundaryHint: 'Changes you make in MindFlow update the same files OpenClaw uses. This is a live attachment, not an imported copy.',
    ...
    docToolsHint: 'When installed, MindFlow prefers the pack binaries over system tools.',
  ...
  videoNote: {
    ...
    exportFooter: 'Generated by MindFlow',
  },
...
5) Keep it concise, bullet-style, in English`,
  ...
  imageManager: {
    ...
    renameDescription: 'MindFlow will rename the image file and rewrite every affected Markdown reference before it leaves this dialog.',
    moveDescription: 'MindFlow will move the image files into the target folder and update every affected Markdown reference in one operation.',
