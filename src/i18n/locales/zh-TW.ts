...
export default {
  ...
  overview: {
    ...
    openClawDesc: 'MindFlow 正在操作 OpenClaw 的同一批檔案。目前識別到的產物檔案數：{count}。',
  ...
  ai: {
    ...
    regenerate: '重新生成',
    errorRetry: '發生錯誤，請重試',
    welcomeAgent: '我是 MindFlow Agent，告訴我你想完成的任務。',
    startTask: '輸入任務指令開始',
    needApproval: '需要審批',
    sendToQueue: '加入佇列',
    ...
    agentInputPlaceholder: '我是 MindFlow，這個模式下我擁有許多強力裝備，可以幫你處理各種事務！',
    chatInputPlaceholder: '我是 MindFlow，你有什麼想和我聊聊的？我知無不言',
    debugPanel: '除錯面板',
    ...
    quickPrompts: {
      polishText: '請潤色《{noteName}》這篇筆記的文字，優化表達方式，使語言更加流暢、精準，同時保持原意不變。請直接輸出潤色後的全文。',
      polishTextGeneric: '請潤色我的文字，優化表達方式，使語言更加流暢、精準，同時保持原意不變。我會在下一條訊息中提供內容。',
      summarizeNote: '請閱讀《{noteName}》這篇筆記，提煉核心要點，生成一份結構清晰的摘要，包含關鍵概念、主要論點和結論。',
      summarizeNoteGeneric: '請幫我總結一篇筆記的核心要點，生成結構清晰的摘要。我會在下一條訊息中提供內容。',
      writeArticle: '請根據《{noteName}》中的素材和思路，撰寫一篇結構完整、邏輯通順的文章。如果素材不足，請先向我確認主題和寫作風格。',
      writeArticleGeneric: '請幫我撰寫一篇文章。請先問我想寫什麼主題、目標讀者和寫作風格。',
      studyNotes: '請分析《{noteName}》中的知識點，整理成系統化的學習筆記，包含概念解釋、要點歸納、易混淆點對比和記憶提示。',
      studyNotesGeneric: '請幫我整理學習筆記。我會在下一條訊息中提供內容，請分析其中的知識點並系統化整理。',
    },
    diffView: {
      title: 'AI 修改預覽',
      previewMode: '預覽',
  ...
  ribbon: {
    ...
    starProject: '為 MindFlow 點個 Star',
  ...
  plugins: {
    ...
    title: '插件',
    intro: 'MindFlow 會優先從預設插件目錄（安裝位置旁）載入插件，並相容工作區 .mindflow/plugins、使用者插件目錄與內建資源。',
  ...
  settingsModal: {
    ...
    openClawTitle: 'OpenClaw 工作區',
    openClawDesc: '把一個外部 OpenClaw 工作區掛到目前 MindFlow 工作區，並明確標示這是一套共享真實檔案而不是匯入副本。',
    openClawEnabled: '啟用整合',
    openClawDisabledDesc: 'OpenClaw 整合目前已關閉。重新啟用前，MindFlow 會把此工作區當作一般資料夾處理。',
    ...
    openClawMountedWorkspaceHint: '把外部 OpenClaw 工作區路徑掛到目前的 MindFlow 工作區上。',
    ...
    openClawBoundaryHint: '你在 MindFlow 中的修改會直接寫回 OpenClaw 正在使用的同一批檔案。這是附著工作區，不是匯入副本。',
...
5) 輸出簡潔、分條，使用繁體中文`,
  ...
  imageManager: {
    ...
    renameDescription: 'MindFlow 將重新命名圖片檔案並重寫所有受影響的 Markdown 引用。',
    moveDescription: 'MindFlow 將把圖片檔案移動到目標資料夾，並在一次操作中更新所有受影響的 Markdown 引用。',
    closeDialog: '關閉對話框',
    newFileName: '新檔名',
