export type MindFlowPluginPermission =
  | "*"
  | "commands:*"
  | "commands:register"
  | "events:*"
...
export interface MindFlowPluginMeta {
  id: string;
  name: string;
  version: string;
  source: string;
...
export interface MindFlowPluginManifestV1 {
  id: string;
  name: string;
  version: string;
  entry: string;
...
export interface MindFlowPluginApi {
  meta: MindFlowPluginMeta;
  logger: {
...
export type MindFlowPluginSetup =
  | void
  | (() => void)
  | Promise<void | (() => void)>
  | { dispose?: () => void };

export type MindFlowPluginEntrypoint = (
  api: MindFlowPluginApi,
  plugin: MindFlowPluginMeta,
) => MindFlowPluginSetup;
